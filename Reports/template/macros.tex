...
\setbeamertemplate{footline}
{
 ...
 \hbox{\begin{beamercolorbox}[wd=\paperwidth,ht=2.25ex,dp=1ex]{}%
     ...
     \hspace*{0.02in}
     \raisebox{-0.0in}{\includegraphics[height=0.3in]{./template/smartAPI-logo-1.pdf}}%
     \hfill\hspace*{0.8in}\insertframenumber{}
     \hfill\raisebox{-0.03in}{\includegraphics[height=0.3in]{./template/smartAPI-logo-2.pdf}}%
 \end{beamercolorbox}}
 \vskip0pt%
}
