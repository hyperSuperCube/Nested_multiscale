...
interpFxy = ns.Field.interpolator_general(field.field, np.array([0,1]), [Bl, Br, Bb, Bu], "y2c")
interpX = ns.Field.interpolator_general(X_xmesh, np.array([0,1]), [0, 1, Xfield.field_mesh[0], Xfield.field_mesh[0]], "y2c")
interpY = ns.Field.interpolator_general(X_ymesh, np.array([0,1]), [Xfield.field_mesh[1], Xfield.field_mesh[1], 0, 1], "y2c")
# print(interpX.shape)
a = 0
b = 1
